...
export const TOOLS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Costs', fields: [{ key: 'hadyCost', label: 'Local sacrifice (sheep) cost', type: 'number', def: 0, hint: 'Needed for hady / damm estimates.' }, { key: 'mealCost', label: 'Cost of one meal (for feeding options)', type: 'number', def: 0 }, { key: 'canAffordHady', label: 'If hady is required: can you afford it?', type: 'radio', options: [{ v: 'yes', t: 'Yes, I can' }, { v: 'no', t: 'No — show the fasting substitute' }], def: 'yes', showIf: { k: 'situation', v: 'tamattu' } }] },
    ],
    faq: [
  ...
  /* ---------- MIRATH ---------- */
  {
    ...
    steps: [
      { title: 'Estate', fields: [CUR, { key: 'estateValue', label: 'Total estate value', type: 'number', def: 0, hint: 'All property, cash and assets at current value.' }, { key: 'bequest', label: 'Bequest amount in the will (optional check)', type: 'number', def: 0, hint: 'Must be within one-third of the estate without heirs’ consent.' }, { key: 'deductions', label: 'Settle first: funeral, debts, bequests', type: 'number', def: 0, hint: 'Funeral costs, all debts, then bequests (max one-third) are paid before any division.' }] },
  ...
  /* ---------- QURBANI & EID ---------- */
  {
    ...
    faq: [
      { q: 'How many shares in a cow?', a: 'Up to seven equal shares — fewer than 7 sharers may share one animal, but every share must be equal and worship-intended. Eight or more splits are invalid.' },
