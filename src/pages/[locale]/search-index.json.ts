...
import { toolIndexItems, duaIndexItems, kalimaIndexItems, meaningIndexItems, waqiahIndexItems, prophetIndexItems, quizIndexItems, hadeesIndexItems, seerahIndexItems, guideIndexItems, tagSurah } from '../../lib/search';
...
export async function GET({ params }: any) {
  ...
  const items = [...toolIndexItems(locale), ...duaIndexItems(locale), ...kalimaIndexItems(locale), ...meaningIndexItems(locale), ...waqiahIndexItems(locale), ...prophetIndexItems(locale), ...quizIndexItems(locale), ...hadeesIndexItems(locale), ...seerahIndexItems(locale), ...guideIndexItems(locale), ...paraItems, ...surahItems, ...list.map(e => ({
    title: e.data.title,
